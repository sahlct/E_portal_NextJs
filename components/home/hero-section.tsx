...
export function HeroSection() {
  ...
  return (
    <section className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-28 pt-4 py-8 lg:py-16">
      <div className="hero-content grid grid-cols-1 md:grid-cols-2 md:gap-8 gap-5 items-center">
        ...
        <div className="order-2 md:order-1">
          ...
          <p className="md:text-lg text-md text-muted-foreground mb-6">
            Discover the latest technology from top brands. Quality products at
            competitive prices. Lorem ipsum, dolor sit amet consectetur
