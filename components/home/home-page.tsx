...
export function HomePage() {
  ...
  return (
    <div className="space-y-12 pb-12">
      ...
      {/* Top Laptops */}
      <section className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-14">
      ...
      <section className="max-w-8xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="bg-gradient-to-r from-primary to-accent p-8 text-primary-foreground flex flex-col justify-center">
          ...
          <div className="bg-secondary p-8 flex items-center justify-center">
            <img src="/vibrant-tech-event.png" alt="Event" className="" />
          </div>
        </div>
      </section>
      ...
      {/* CCTV & WiFi */}
      <section className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-14">
        <h2 className="text-3xl font-semibold mb-6">Security & Connectivity</h2>
